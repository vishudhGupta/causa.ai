      ...
      <div className='form_section'>
        <form className="form_container" action='/'>
          ...
          <div className='input_fields'>
            <label htmlFor='court'>Filling Number<span className='asteric_important'>*</span></label>
            <input type='text' placeholder='Type Filling Number' className='fir_number_input' />
          </div>
          <div className='input_fields'>
            <label htmlFor='court'>Year<span className='asteric_important'>*</span></label>
